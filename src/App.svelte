	...
	<div class="section" id="home">
		...
		<div id="main-pattern">
			<div class="pattern-image">
				<img id="mascot-filled" src="img/items/filled.png" alt="mascot">
			</div>
			<div class="pattern-image">
				<img id="mascot-unfilled" src="img/items/unfilled.png" alt="mascot">
			</div>
			<div class="pattern-image">
				<img id="mascot-filled" src="img/items/filled.png" alt="mascot">
			</div>
		...
		<div>
			<ul style="list-style: none;" class="qanda">
				...
				<li>
					...
					<p class="answer">
						Hardware: Bring your hacking device and any accessories it requires.
						Sleeping: Feel free to bring a sleeping bag, pillows, and/or blankets.
						Personal Hygiene: Showers will be provided. Bring a bath towel and personal hygiene products.
						Photo ID: You must bring a photo ID with you to check in, and the name on the ID must match the name entered during registration.
					</p>
				</li>
				<li>
